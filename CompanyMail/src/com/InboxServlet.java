...
public class InboxServlet extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session==null){
			...
			out.print("<span style='float:right;margin-right:15px;'>Hi, "+email+"</span>");
			out.print("<h1 class='mark1'>Inbox</h1>");
			...
			try{
				...
				out.print("<table style='width:700px;margin-left:20%;' class='table table-bordered'>");
				out.print("<tr class='inboxtr'><td>Sender</td><td>Subject</td></tr>");
				while(rs.next()){
